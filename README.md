...
•	**Cell_ID_unique** : Represents the field of view (FOV) and the cell number (e.g., "001_10" = FOV 001, cell 10)

•	**Area_Cell** : The area of the cell in pixels (corresponding to the segmentation mask)
